...
# with P4wnP1 v0.1.1 with oled drivers and menu preinstalled with Win32disk
...
#download the libpcap0.8 1.10.0-2 to switch between while using bettercap
cd /root/tools/libpcap
...
#download the libpcap0.8 1.10.0-2 to switch between the two version while using bettercap
cd /root/tools/libpcap
wget http://ftp.ca.debian.org/debian/pool/main/libp/libpcap/libpcap0.8_1.10.0-2_armel.deb
